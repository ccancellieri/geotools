...
public class DelegateSimpleFeatureReader extends DelegateSimpleFeature {
	...
	protected SimpleFeatureReader delegate;

	protected final SimpleFeatureType schema;

	public DelegateSimpleFeatureReader(CacheManager cacheManager, SimpleFeatureReader delegate,
	...
	protected void setDelegate(SimpleFeatureReader fr){
		this.delegate=fr;
	}

	@Override
	protected SimpleFeature getNextInternal() throws IllegalArgumentException, NoSuchElementException, IOException{
		if (delegate==null)
