...
@Component
public class SchemaOpSPI extends BaseOpSPI<SchemaOp,Name,SimpleFeatureType> implements Serializable {
    ...
    @Override
    public SchemaOp createInstance(CacheManager cacheManager, final CachedOpStatus<Name> uniqueName) throws IOException {
